# Overview: python script using the open weather map api to visualize the weather of 500 cities across the world of varying distance from the equator. https://openweathermap.org/api 
